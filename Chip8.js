...
<div>
    ...
    <br><br>
    <marquee id="bleh" behavior= "Scroll" direction= "left"><div>Team #16 Presents: CHIP-8 Emulator</div></marquee>
</div>
<br>
<div id="sound">
    Beep!
    ...
    setInterval(function() {
            try {
                if(cpu.hasROM) {
                    ...
                    if(cpu.getOpcode() > 0 && (!cpu.paused || cpu.stepForward)) {
